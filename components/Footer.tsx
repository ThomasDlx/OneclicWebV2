    ...
    <footer className="bg-gray-50 border-t border-gray-200/50">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Colonne 2 : Services */}
          <div>
            <h3 className="text-sm font-semibold text-black mb-4">Services</h3>
          ...
          <div>
            <h3 className="text-sm font-semibold text-black mb-4">Entreprise</h3>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-sm text-gray-400">
                <a href="mailto:contact@oneclickweb.fr" className="hover:text-black transition-colors">
